...
path1 = os.path.join(SAPATH, "Sensor_1")
files1 = sorted(glob(path1+'/'+"*.raw")), 'sensor1'
path2 = os.path.join(SAPATH, "Sensor_3")
files2 = sorted(glob(path2+'/'+"*.raw")), 'sensor3'
path3 = os.path.join(SAPATH, "Sensor_8")
files3 = sorted(glob(path3+'/'+"*.raw")), 'sensor8'

files, sensorname = files3
